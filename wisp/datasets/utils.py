...
from wisp.datasets.base_datasets import WispDataset, MultiviewDataset, SDFDataset, BaseImageDataset
...
def load_image_dataset(dataset_path: str, dataset_num_workers: int = -1, transform: Callable = None,
                           split: str = None, **kwargs) -> MultiviewDataset:
    
    return _load_dataset(BaseImageDataset, dataset_path, dataset_num_workers, transform, split, **kwargs)
