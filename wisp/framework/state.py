...
@dataclass
class ImageOptimizationState:
    """
    Holds information about an optimization task wisp is currently running.
    This is used to cache information in trainers.
    """
...
class ImageDataState:
    """
    Holds information about the data, task wisp is currently running.
    """
...
class ImageState:
    ...
    """ Holds information about the image optimization task wisp is currently running. """
    optimization: ImageOptimizationState = field(default_factory=ImageOptimizationState)

    """ Holds information about the data wisp is currently running on. """
    data: ImageDataState = field(default_factory=ImageDataState)